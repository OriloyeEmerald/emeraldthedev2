  ...
  return (
    <section className='p-[1.5rem]'>
        <div className='flex justify-between items-center text-[#33323d]'>
            ...
            <nav className={showMenu ?'flex-col absolute right-[1.5rem] top-[4.5rem] bg-[#33323d] text-white w-[255px] h-[180px] py-[2.2rem] gap-[1rem] uppercase text-[.9rem] font-[100]': 'sm:flex sm:items-center gap-[2rem] uppercase text-[.8rem] hidden'} style={{display: showMenu && 'flex'}}>
